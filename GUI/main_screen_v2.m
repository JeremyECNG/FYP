function varargout = main_screen_v2(varargin)
% MAIN_SCREEN_V2 MATLAB code for main_screen_v2.fig
%      MAIN_SCREEN_V2, by itself, creates a new MAIN_SCREEN_V2 or raises the existing
%      singleton*.
%
%      H = MAIN_SCREEN_V2 returns the handle to a new MAIN_SCREEN_V2 or the handle to
%      the existing singleton*.
%
%      MAIN_SCREEN_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN_SCREEN_V2.M with the given input arguments.
%
%      MAIN_SCREEN_V2('Property','Value',...) creates a new MAIN_SCREEN_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before main_screen_v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main_screen_v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main_screen_v2

% Last Modified by GUIDE v2.5 17-Jan-2018 16:21:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @main_screen_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @main_screen_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before main_screen_v2 is made visible.
function main_screen_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to main_screen_v2 (see VARARGIN)

% Choose default command line output for main_screen_v2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes main_screen_v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = main_screen_v2_OutputFcn(hObject, eventdata, handles) 
