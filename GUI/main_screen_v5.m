...
switch display_flag %Variable for determining whether a node or link is to be displayed
 ...
 case 1 %Link is selected
     ...
     %Plot Datatips for transmitter and receiver
                    ...
                    case 'DSC'
                         ...
                         switch link_con(link_num).channel.path_loss_model
                                     ...
                                     case 'FSPL'
                                         ...
                                         i_am_legend = legend(handles.map,[handles.tput_plot1],{txt1})
                             ...
                             otherwise
                                 ...
                                 switch link_con(link_num).channel.path_loss_model
                                     ...
                                     case 'FSPL'
                                         ...
                                         i_am_legend = legend(handles.map,[handles.tput_plot1,handles.tput_plot2,handles.tput_plot3],{txt1,txt2,txt3})
