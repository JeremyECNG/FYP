...
% Last Modified by GUIDE v2.5 01-Mar-2018 15:21:50
...
location_flag = get(handles.node_location_edit, 'UserData');
...
set(handles.node_location_edit, 'UserData', 0);
...
function shownodee(hObject,eventdata)
h_nodec = findobj('Tag','figure_node_edit');
if (isempty(h_nodec))
  % Display Error MEssage 
else
  figure(h_nodec);
